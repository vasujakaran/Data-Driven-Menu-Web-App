...
restaurant1 = Restaurant(name="Urban Burger", address="200 Lincoln Ave, Salinas, CA 93901")
...
restaurant2 = Restaurant(name="Super Stir Fry", address="65 West Alisal St., # 101, Salinas, CA 93901")
...
restaurant1 = Restaurant(name="Panda Garden",address="1656 Union Street Eureka")
...
restaurant1 = Restaurant(name="Thyme for That Vegetarian Cuisine ",
                         address="1976 East Martin Luther King Jr. Blvd Stockton")
...
restaurant1 = Restaurant(name="Tony\'s Bistro ", address="4050 Taylor Street San Diego")
...
# Menu for Andala's
restaurant1 = Restaurant(name="Andala\'s", address="464 W. 4th St., San Bernardino")
...
restaurant1 = Restaurant(name="Auntie Ann\'s Diner' ", address="500 South Main Street, Bishop")
...
restaurant1 = Restaurant(name="Cocina Y Amor ", address="500 South Main Street, Bishop")
...
restaurant1 = Restaurant(name="State Bird Provisions", address="100 S. Main Street, Los Angeles")
session.add(restaurant1)
session.commit()
